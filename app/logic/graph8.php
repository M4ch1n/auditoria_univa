...
$plot->SetTitle("En el transcurso de un proyecto,\n han cambiado requerimientos que requieran habilidades distintas\n a las planteadas inicialmente");
